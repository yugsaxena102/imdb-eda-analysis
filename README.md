...
# Exploratory Data Analysis of 19,808 Movies
...
**2021** as the year with the highest total industry revenue in the dataset, with reported total revenue of approximately **$20.45 billion**.

## Sequel Effect

Movies identified as sequel-like titles had a higher average gross income in this analysis:

| Movie Type | Average Gross Income |
|-----------|-------------------|
| Non-sequel | $16.09 million |
| Sequel-like | $25.45 million |
